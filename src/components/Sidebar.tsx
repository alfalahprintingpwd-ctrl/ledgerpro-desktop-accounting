...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-64 bg-[#1E293B] text-slate-300 flex flex-col shrink-0 border-r border-slate-700/60 h-screen sticky top-0 select-none">
      {/* Brand Header */}
      <div className="p-4 border-b border-slate-700/60 flex items-center gap-3 bg-[#0F172A]/40">
      ...
      <div className="p-3 border-t border-slate-700/60 bg-[#0F172A]/50 space-y-2">
        {onOpenShortcutsHelp && (
          <button
            onClick={onOpenShortcutsHelp}
            className="w-full flex items-center justify-between px-3 py-2 bg-slate-800/80 hover:bg-slate-700 text-slate-300 hover:text-white rounded-lg text-xs font-medium border border-slate-700/50 transition cursor-pointer"
          >
        ...
        <button
          onClick={onLock}
          className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-lg text-xs font-medium border border-slate-700/50 transition cursor-pointer"
        >
