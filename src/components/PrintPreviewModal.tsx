  ...
  return (
    <div className="fixed inset-0 z-[100] bg-slate-950/80 backdrop-blur-md flex flex-col overflow-hidden">
          ...
          <div>
            <h2 className="text-sm font-bold text-white flex items-center gap-2">
              ...
              <span className="text-[10px] font-mono text-slate-400 bg-slate-800 px-2 py-0.5 rounded border border-slate-700">
                {orientation === 'landscape' ? 'A4 Landscape • 297 x 210 mm' : 'A4 Portrait • 210 x 297 mm'}
              </span>
            </h2>
      ...
      <div className="flex-1 overflow-auto p-8 flex justify-center items-start bg-slate-950">
        <div
          className="print-preview-content transition-transform duration-150 origin-top bg-white text-slate-900 shadow-2xl rounded-sm p-6 md:p-8 border border-slate-300"
          style={{
