        ...
        {step === 1 ? (
          <form onSubmit={handleNextStep} className="p-6 md:p-8 space-y-6">
            <h2 className="text-lg font-semibold text-slate-800 border-b border-slate-100 pb-2 flex items-center gap-2">
              <Building2 className="w-5 h-5 text-blue-600" /> 1. Business & Contact Information
            </h2>

            {/* Logo & Basic Info */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-1 flex flex-col items-center justify-center border-2 border-dashed border-slate-200 rounded-xl p-4 bg-slate-50 text-center hover:bg-slate-100 transition">
                {logoUrl ? (
                  ...
                  <label className="cursor-pointer flex flex-col items-center">
                    ...
                    <span className="text-sm font-medium text-slate-700">Upload Business Logo</span>
              ...
              <div className="md:col-span-2 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-slate-800 text-sm"
                  />
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 outline-none text-slate-800 text-sm"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-slate-600 mb-1">
            ...
            {/* CEO & Signatures */}
            <h2 className="text-lg font-semibold text-slate-800 border-b border-slate-100 pt-4 pb-2 flex items-center gap-2">
              <FileText className="w-5 h-5 text-blue-600" /> Executive & Stamp Information
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="border border-slate-200 rounded-lg p-3 bg-slate-50 text-center">
                ...
                {ceoSignatureUrl ? (
                  ...
                  <label className="cursor-pointer inline-flex items-center gap-1.5 text-xs text-blue-600 hover:text-blue-800 font-medium py-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 outline-none text-slate-800 text-sm"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-slate-600 mb-1">
          ...
          <form onSubmit={handleFinalize} className="p-6 md:p-8 space-y-6">
            <h2 className="text-lg font-semibold text-slate-800 border-b border-slate-100 pb-2 flex items-center gap-2">
              <Key className="w-5 h-5 text-blue-600" /> 2. Security Password & Offline Password Recovery Setup
            </h2>
            ...
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-4">
              <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider flex items-center gap-1.5">
                <Lock className="w-4 h-4 text-blue-600" /> Main Software Password
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-semibold uppercase tracking-wider text-slate-600 mb-1">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 outline-none text-slate-800 text-sm bg-white"
                  />
            ...
            <div className="space-y-4 pt-2">
              <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider flex items-center gap-1.5 border-b border-slate-100 pb-2">
                <Shield className="w-4 h-4 text-blue-600" /> Business Identity Verification Details
              </h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-lg border border-slate-300 text-xs text-slate-800 focus:ring-2 focus:ring-blue-500 outline-none"
                  />
                </div>
                <div>
                  <label className="block text-[11px] font-semibold text-slate-700 mb-1">
            ...
            <div className="space-y-4 pt-2">
              <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider flex items-center gap-1.5 border-b border-slate-100 pb-2">
                <ShieldCheck className="w-4 h-4 text-blue-600" /> Security Questions & Answers
              </h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 rounded-lg border border-slate-300 text-xs text-slate-800 focus:ring-2 focus:ring-blue-500 outline-none bg-white"
                  >
              ...
              <div className="max-w-xs pt-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-slate-300 text-xs text-slate-800 focus:ring-2 focus:ring-blue-500 outline-none font-mono"
                />
                <span className="text-[10px] text-slate-500 mt-0.5 block">Stored as a secure offline hash</span>
              </div>
            </div>
            ...
            <div className="space-y-3 pt-3 border-t border-slate-100">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-2.5 py-1 text-xs border border-slate-300 hover:bg-slate-50 text-slate-700 rounded-lg flex items-center gap-1 transition"
                >
                  <RefreshCw className="w-3 h-3 text-slate-500" /> Regenerate Key
                </button>
              </div>
            ...
            <div className="pt-4 flex items-center justify-between border-t border-slate-100">
              <button
                type="button"
                onClick={() => setStep(1)}
                className="px-4 py-2 border border-slate-300 hover:bg-slate-50 text-slate-700 text-sm font-medium rounded-lg transition"
              >
