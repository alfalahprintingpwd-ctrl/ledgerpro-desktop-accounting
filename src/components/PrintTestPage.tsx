...
import { getPrintSettings, triggerPrintDocument } from '../lib/print';
...
export const PrintTestPageModal: React.FC<PrintTestPageProps> = ({
  ...
  const handlePrint = () => {
    ...
    if (success) {
      setToast({
        type: 'success',
        message: 'Print job dispatched to Windows Print Spooler!',
      });
    }
  };
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/80 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto print:p-0 print:bg-white">
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-4xl max-h-[92vh] flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-slate-100 flex justify-center">
          <div className="w-full max-w-[210mm] shadow-md bg-white rounded-md">
            {renderTestDocument()}
          </div>
        </div>
      </div>
