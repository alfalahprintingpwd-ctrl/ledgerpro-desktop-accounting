...
export const HelpAbout: React.FC<HelpAboutProps> = ({ onOpenShortcutsHelp }) => {
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6 text-slate-800 dark:text-slate-200 text-xs">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
          <HelpCircle className="w-6 h-6 text-blue-600 dark:text-blue-400" /> Help & Accounting Guide
        </h1>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 shadow-2xs space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-2">
            <h2 className="text-sm font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
              <Keyboard className="w-4 h-4 text-blue-600 dark:text-blue-400" /> Keyboard Shortcuts System
            </h2>
            {onOpenShortcutsHelp && (
              <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
            {[
              ...
              <div
                key={idx}
                className="p-2.5 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-700/60 flex items-center justify-between"
              >
                <span className="text-slate-600 dark:text-slate-300 text-[11px] font-medium">{item.desc}</span>
                <kbd className="px-2 py-1 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded font-mono font-bold text-[11px] text-slate-900 dark:text-slate-100 shadow-2xs">
                  {item.key}
                </kbd>
              </div>
            ))}
        ...
        <div className="space-y-3">
          <h2 className="text-sm font-bold text-slate-900 dark:text-slate-100 border-b border-slate-100 dark:border-slate-800 pb-2 flex items-center gap-2">
            <BookOpen className="w-4 h-4 text-blue-600 dark:text-blue-400" /> Reliable Accounting Logic
          </h2>
          ...
          <div className="space-y-2 leading-relaxed text-slate-600 dark:text-slate-300">
            <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-700/60">
              <strong className="text-slate-900 dark:text-slate-100 block mb-1 font-bold">Sales vs Received vs Pending:</strong>
              <p>
            ...
            <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-700/60">
              <strong className="text-slate-900 dark:text-slate-100 block mb-1 font-bold">Cash vs Bank Management:</strong>
              <p>
            ...
            <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-700/60">
              <strong className="text-slate-900 dark:text-slate-100 block mb-1 font-bold">Monthly Folder Archiving:</strong>
              <p>
        ...
        <div className="space-y-2 pt-2 border-t border-slate-100 dark:border-slate-800">
          <h2 className="text-sm font-bold text-slate-900 dark:text-slate-100">Software Information & System Specs</h2>
          <div className="bg-slate-900 text-white p-4 rounded-xl space-y-1 font-mono text-[11px] border border-slate-800">
